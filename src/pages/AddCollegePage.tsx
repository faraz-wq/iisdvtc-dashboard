      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Fill in the college details. Required fields are marked with an
            asterisk (*).
          </p>
        </div>
        <Form {...form}>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        value={field.value.join(", ")} // Convert array back to string for display
                        onChange={(e) => {
                          const rawInput = e.target.value;
                          const phoneNumbers = rawInput
                            .split(",") // Split the input string by commas
                            .map((num) => num.trim()) // Trim whitespace from each number
                            .filter((num) => num.length > 0); // Remove empty entries
                          field.onChange(phoneNumbers); // Update the field value as an array
                        }}
                      />
                    </FormControl>
                    <FormDescription>
